...
class QarmSimulator:
    ...
    def _load_targets(self, csv_file='data/reachable_targets.csv'):
        """
    ...
    def render(self, show=True, block=False):
        ...
        # 添加轴标签
        self.ax.text(arrow_length * 1.2, 0, 0, 'X', color='red', fontsize=11, fontweight='bold')
        self.ax.text(0, arrow_length * 1.3, 0, 'Y', color='green', fontsize=11, fontweight='bold')
        self.ax.text(0, 0, arrow_length * 1.2, 'Z', color='blue', fontsize=11, fontweight='bold')
...
def create_human_arm_comparison():
    ...
    arrow_len = 0.15
    origin = [0, 0, 0]
    ax1.quiver(origin[0], origin[1], origin[2], arrow_len, 0, 0, color='red', arrow_length_ratio=0.2, linewidth=2)
    ax1.quiver(origin[0], origin[1], origin[2], 0, arrow_len, 0, color='green', arrow_length_ratio=0.2, linewidth=2)
    ax1.quiver(origin[0], origin[1], origin[2], 0, 0, arrow_len, color='blue', arrow_length_ratio=0.2, linewidth=2)
    ax1.text(arrow_len * 1.2, 0, 0, 'X', color='red', fontsize=10, fontweight='bold')
    ax1.text(0, arrow_len * 1.3, 0, 'Y', color='green', fontsize=10, fontweight='bold')
    ax1.text(0, 0, arrow_len * 1.2, 'Z', color='blue', fontsize=10, fontweight='bold')
    ...
    arrow_len = 0.15
    origin = [0, 0, 0]
    ax2.quiver(origin[0], origin[1], origin[2], arrow_len, 0, 0, color='red', arrow_length_ratio=0.2, linewidth=2)
    ax2.quiver(origin[0], origin[1], origin[2], 0, arrow_len, 0, color='green', arrow_length_ratio=0.2, linewidth=2)
    ax2.quiver(origin[0], origin[1], origin[2], 0, 0, arrow_len, color='blue', arrow_length_ratio=0.2, linewidth=2)
    ax2.text(arrow_len * 1.2, 0, 0, 'X', color='red', fontsize=10, fontweight='bold')
    ax2.text(0, arrow_len * 1.3, 0, 'Y', color='green', fontsize=10, fontweight='bold')
    ax2.text(0, 0, arrow_len * 1.2, 'Z', color='blue', fontsize=10, fontweight='bold')
